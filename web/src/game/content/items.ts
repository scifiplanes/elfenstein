...
export const DEFAULT_ITEMS: ItemDef[] = [
  ...
  { id: 'Stone', name: 'Stone', icon: { kind: 'emoji', value: '🪨' }, tags: ['material', 'weapon', 'oneHand'], equipSlots: ['handLeft', 'handRight'] },
  { id: 'Stick', name: 'Stick', icon: { kind: 'emoji', value: '🪵' }, tags: ['material', 'weapon', 'oneHand'], equipSlots: ['handLeft', 'handRight'] },
  { id: 'Club', name: 'Club', icon: { kind: 'emoji', value: '🏏' }, tags: ['weapon', 'oneHand'], equipSlots: ['handLeft', 'handRight'] },
  {
    id: 'Spear',
    name: 'Spear',
  ...
  { id: 'Firebolt', name: 'Firebolt', icon: { kind: 'emoji', value: '🔥' }, tags: ['weapon', 'oneHand'], equipSlots: ['handLeft', 'handRight'] },
  { id: 'Fireshield', name: 'Fireshield', icon: { kind: 'emoji', value: '🛡️' }, tags: ['tool', 'oneHand'], equipSlots: ['handLeft', 'handRight'] },
  { id: 'Sling', name: 'Sling', icon: { kind: 'emoji', value: '🪃' }, tags: ['weapon', 'tool', 'oneHand'], equipSlots: ['handLeft', 'handRight'] },
  { id: 'Bolas', name: 'Bolas', icon: { kind: 'emoji', value: '🪢' }, tags: ['weapon', 'tool', 'oneHand'], equipSlots: ['handLeft', 'handRight'] },
  {
    id: 'Bow',
    name: 'Bow',
    icon: { kind: 'emoji', value: '🏹' },
