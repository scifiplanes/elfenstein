...
export function DitheredFrameRoot(props: { state: GameState; dispatch: Dispatch<Action>; content: ContentDB }) {
  ...
  const tradeModalOpen =
    Boolean(state.ui.tradeSession) &&
    ((state.ui.screen === 'hub' && state.ui.tradeSession!.kind === 'hub_innkeeper') ||
      (state.ui.screen === 'game' && state.ui.tradeSession!.kind === 'floor_npc'))
