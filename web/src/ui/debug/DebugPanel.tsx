...
export function DebugPanel(props: { state: GameState; dispatch: Dispatch<Action> }) {
  ...
  const portraitSliders: Array<Omit<Slider, 'key'> & { key: NumericRenderTuningKey }> = useMemo(
    () => [
      ...
      {
        key: 'vitalsHungerDrainPerStep',
        label: 'Vitals drain: hunger / forward step',
        min: 0,
        max: 3,
        step: 0.02,
        format: (v) => v.toFixed(2),
      ...
      {
        key: 'vitalsThirstDrainPerStep',
        label: 'Vitals drain: thirst / forward step',
        min: 0,
        max: 3,
        step: 0.02,
        format: (v) => v.toFixed(2),
      ...
      {
        key: 'vitalsHungerDrainPerTurn',
        label: 'Vitals drain: hunger / in-place turn',
        min: 0,
        max: 3,
        step: 0.02,
        format: (v) => v.toFixed(2),
      ...
      {
        key: 'vitalsThirstDrainPerTurn',
        label: 'Vitals drain: thirst / in-place turn',
        min: 0,
        max: 3,
        step: 0.02,
        format: (v) => v.toFixed(2),
      ...
      {
        key: 'vitalsDrainStaminaStepPenaltyStarving',
        label: 'Step STA penalty while Starving',
        min: 0,
        max: 10,
        step: 1,
        format: (v) => String(Math.round(v)),
      ...
      {
        key: 'vitalsDrainStaminaStepPenaltyDehydrated',
        label: 'Step STA penalty while Dehydrated',
        min: 0,
        max: 10,
        step: 1,
        format: (v) => String(Math.round(v)),
      ...
      {
        key: 'vitalsDefensePenaltyStarving',
        label: 'Defense penalty vs NPCs while Starving',
        min: 0,
        max: 5,
        step: 1,
        format: (v) => String(Math.round(v)),
      ...
      {
        key: 'vitalsDefensePenaltyDehydrated',
        label: 'Defense penalty vs NPCs while Dehydrated',
        min: 0,
        max: 5,
        step: 1,
        format: (v) => String(Math.round(v)),
