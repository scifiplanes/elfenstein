...
export function DebugPanel(props: { state: GameState; dispatch: Dispatch<Action> }) {
  ...
  const portraitSliders: Array<Omit<Slider, 'key'> & { key: NumericRenderTuningKey }> = useMemo(
    () => [
      ...
      {
        key: 'vitalsHungerDrainPerGameMin',
        label: 'Vitals drain: hunger (pts / real min, dungeon)',
        min: 0,
        max: 120,
        step: 0.5,
      ...
      {
        key: 'vitalsThirstDrainPerGameMin',
        label: 'Vitals drain: thirst (pts / real min, dungeon)',
        min: 0,
        max: 120,
        step: 0.5,
        format: (v) => v.toFixed(1),
